        ...
        <html lang="en">
            <body ref={container} className="gap-8 overflow-hidden ">
                ...
                <div className="md:hidden flex w-full h-full">
                  <div className="flex w-full h-full items-center justify-center p-6 item">
                    <p>
                    This website is best viewed on a desktop, to view on mobile device please head to /mobile page <a href="/mobile">here</a>.</p> 
                  </div>
                </div>
            </body>
        </html>
