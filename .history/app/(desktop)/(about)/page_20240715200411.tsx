    ...
    <div className="" >
      ...
      <div className="w-[calc(100vw)] h-screen absolute top-0 left-0 overflow-hidden">
        ...
        <video autoPlay muted loop  controls={false} ref={videoRef} className="overflow-hidden z-[-1] w-full h-full object-cover" >
          <source src="../Comp 2.mp4/gr-1.mp4" type="video/mp4" className="aspect-video"/>
          Your browser does not support the video tag.
        </video>
        {/* <iframe src="https://drive.google.com/file/d/10WtVq9SgmdrOWbVgdihs44Kux2ZQhvuI/preview" className="overflow-hidden z-[-1] w-full h-full object-cover" width="640" height="480" allow="autoplay"></iframe> */}
