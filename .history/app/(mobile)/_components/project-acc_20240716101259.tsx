...
import ProjectShowcase, { MobileProjectShowcase } from '@/components/projects/project-showcase'
...
const ProjectAccordion = ({card}:{card:ProjectType}) => {
  ...
  return (
    <div className='border rounded-md w-full p-3 px-5 border-[#344547] relative'>
