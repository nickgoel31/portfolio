...
const MobilePage = () => {
  ...
  return (
    <div className='w-full h-screen'>
      ...
      <div className=''>
        <div className="z-[1] absolute top-1/2 left-1/2 opacity-10">
          <Image src={"/symbol1.png"} alt="Symbol" width={1000} height={1000} className="w-96"/>
        </div>

        <div className="z-[21] absolute top-1/2 left-1/2 opacity-10 flex flex-col justify-center items-center gap-6">
