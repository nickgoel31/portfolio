...
export const cards:ProjectType[] = [
    ...
    { id: 2, title: 'AI Website Builder', top: '20', zIndex: '12', projectLink: '', projectGithub:'', projectVideoPath:'',status: "COMPLETED" },
    { id: 3, title: 'Presentation Maker', top: '30', zIndex: '13', projectLink: '', projectGithub:'', projectVideoPath:'',status: "COMPLETED" },
  ];