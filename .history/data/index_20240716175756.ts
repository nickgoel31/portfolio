...
export const cards:ProjectType[] = [
  ...
  export const skillBoxes = [
    ...
    { id: "skill5", x: 200, y: 300, width: 180, height: 100, text: 'Django', bgColor: '#80cad510', textColor: '#b6eef790', fontSize: '25px', information: "Django is a high-level Python web framework that encourages rapid development and clean, pragmatic design.",level: 'advanced' },
