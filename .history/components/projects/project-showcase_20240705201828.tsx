        ...
        <div className='w-[90%] aspect-video overflow-hidden z-[10] rounded-md  border border-[#274552] bg-[#0b1114]'>
            {showcaseType === "Github" && (
                <div className='w-full h-full flex flex-col relative'>
                    ...
                    <div className='absolute bottom-0 left-0 w-96 h-96 bg-gradient-radial from-transparent via-black/10 to-black/80 z-[3] rounded-full scale-[2] translate-y-96 translate-x-'>
