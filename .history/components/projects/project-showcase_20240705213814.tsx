  ...
  return (
    <div className='w-full h-full  absolute left-0 top-0 flex flex-col gap-6 items-center justify-center py-12 px-6'>
        ...
        <div className='w-[90%] aspect-video overflow-hidden z-[10] rounded-md relative  border border-[#274552] bg-[#0b1114]'>
            ...
            {showcaseType === "Link" && (
                <div className='w-full h-full github-repo relative'>
                    <div className='w-full h-full flex items-center justify-center absolute left-0 top-0'></div>
                    <iframe src={currentProject.projectLink} name="myiFrame" scrolling="no" className='w-full h-full' ></iframe>
                </div>
            )}
        </div>
    </div>
