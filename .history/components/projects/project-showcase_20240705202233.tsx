...
const ProjectShowcase = () => {
  ...
  return (
    <div className='w-full h-full  absolute left-0 top-0 flex flex-col gap-6 items-center justify-center py-12 px-6'>
        ...
        <div className='w-[90%] aspect-video overflow-hidden z-[10] rounded-md   bg-[#0b1114]'>
            {showcaseType === "Github" && (
                <div className='w-full h-full flex flex-col relative github-repo border border-[#274552] rounded-lg'>
