    ...
    <div className='w-full h-full flex flex-col gap-8 items-center justify-center py-8 px-6'>
        ...
        <div className='flex gap-3 items-center '>
            ...
            <button onClick={() => {
                ...
                setLoading(true)
            }} className={`rounded-full p-2 px-6 border border-[#274552] bg-[#0e171b] flex items-center justify-center gap-2 transition-custom hover:border-[#89bcd2] hover:bg-[#89bcd2] hover:shadow-contactLinks hover:text-[#0e171b] font-semibold text-[#a4c4d1] ${showcaseType === "Link" && 'border-[#89bcd2] bg-[#89bcd2] shadow-contactLinks !text-[#0e171b]'}`}>
                <LinkIcon />
                Link
            </button>
        </div>
