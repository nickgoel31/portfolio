...
const ProjectShowcase = () => {
  ...
  return (
    <div className='w-full h-full  absolute left-0 top-0 flex flex-col gap-6 items-center justify-center py-12 px-6'>
        <div className={`absolute flex items-center justify-center top-4 left-1/2 -translate-x-1/2 text-xs font-medium p-1 px-2 rounded-full border  ${currentProject.status === "COMPLETED" ? '': ''}`}>
