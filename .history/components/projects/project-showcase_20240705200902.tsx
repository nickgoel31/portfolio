...
import { Folder, Link, Video } from 'lucide-react'
            ...
            {showcaseType === "Github" && (
                <div className='w-full h-full flex flex-col '>
                    ...
                    <div className='flex flex-col w-full'>
                        <div className='w-full h-8 p-2 px-4 text-xs font-medium flex items-center justify-between border-b border-[#274552] hover:bg-foreground'>
                            <div className='flex items-center gap-2'>
                                <Folder size={15}/>
