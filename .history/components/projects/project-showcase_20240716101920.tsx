...
export const MobileProjectShowcase = () => {
  ...
  return (
    <div className='w-full h-full flex flex-col gap-6 items-center justify-center py-12 px-6'>
        <div className={`flex items-center justify-center top-4 left-1/2 -translate-x-1/2 text-xs font-medium p-1 px-2 rounded-full border ${currentProject.status === "COMPLETED" ? 'border-green-400 text-green-300': 'border-yellow-500 text-yellow-300'}`}>
            {currentProject.status === "COMPLETED" ? "Ready" : "In Progress"}
        </div>
        <div className='flex gap-3 items-center '>
            <button onClick={() => {
