            ...
            {showcaseType === "Video" && (
                <div className='w-full h-full'>
                    {currentProject.projectVideoPath ? (
                        <iframe width="560" height="315" src="https://www.youtube.com/embed/N1Sgukwilh0?si=ydR3T7B8AZ9IIBxO" title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                    ):(
                        <div className='w-full h-full flex items-center justify-center'>
                            <p className='text-xs font-medium opacity-70'>
                                No Video Showcase
