...
export const SkillBox = ({...props}:Props) => {
  const [modal, setModal] = useState(false)
    return (
      <>
        {modal && (
          <div className="fixed w-screen h-screen z-[100] left-0 top-0">
            <span className="backdrop-blur-sm flex-[1.5]"></span>
            <div className=" bottom-0 left-0 w-full p-6 py-8 z-[10] bg-[#0f1618] border border-[#1e2e32]">
