...
export const SkillBox = ({...props}:Props) => {
  const [modal, setModal] = useState(false)
    return (
      <>
        {modal && (
          <div className="fixed w-screen h-screen z-[100] backdrop-blur-sm left-0 top-0" on>
            <div className="absolute bottom-0 left-0 w-full p-6 py-8 z-[10] bg-[#0f1618] border border-[#1e2e32]">
